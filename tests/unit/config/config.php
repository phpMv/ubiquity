...
return array ("siteUrl" => "http://127.0.0.1/","database" => array ("type" => "mysql","dbName" => "messagerie","serverName" => DB_SERVER,"port" => 3306,"user" => "root","password" => "","options" => array (),"cache" => false ),"namespaces" => array (),"sessionName" => "messagerie","test" => false,"debug" => true,"di" => array (),
