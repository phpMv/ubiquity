...
(11, 'MongoDb', '', '', 1),
(16, 'newGroupe', 'newGroupe', '', 4),
(18, 'Lycéens', 'lyc', 'lyceens', 4),
(19, 'Les miens', 'myaddressmail@gmail.com', 'miens', 4),
(20, 'TestGroupe', 'noemail@gmail.com', '', 4);
...
DROP TABLE IF EXISTS `groupeusers`;
...
(3, 'IUT Campus III', '', ''),
(4, 'Lycée Sainte-Ursule', 'lycee-sainte-ursule.com', '');
