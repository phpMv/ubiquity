...
/**
 * Ubiquity\contents\validation\validators\comparison$LessThanOrEqualValidator
...
class LessThanOrEqualValidator extends ValidatorHasNotNull {
	...
	public function asUI(): array {
		$rule = new CustomRule ( 'lessthanoreq', "function(v,lessThan){ return v<=lessThan;}", $this->_getMessage (), $this->ref );
